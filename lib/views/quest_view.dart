...
const List<Choice> choices = const <Choice> [
  ...
  const Choice(
    title: 'LA CAFETA', 
    icon: Icons.favorite,  
    description:"Es el laboratorio de innovación de UTP, IDAT y ZEGEL IPAE está en el piso 7 del edificio Washintong.",
    mision: "Pregúntale a Fer sobre el propósito de la cafeta, y qué es el team espresso, si no lo encuentras pregúntale a Diego.",
    points: "3 puntos",
  ),
  const Choice(
    title: 'RESEARCH', 
    icon: Icons.search, 
    description: "El equipo de investigación es crucial para detectar las problemáticas de los estudiantes y plasmar hipótesis que podrían solucionarlas.",
    mision: "Pregúntale a Nadia sobre la prueba que está corriendo en los salones de clase, si no la encuentras pregúntale a Diego.",
    points: "4 puntos",
  ),
  const Choice(
    title: 'ID', 
    ...
    mision: "Pregúntale a Fuku que es EVA, si no lo encuentras pregúntale a Diego.",
    points: "3 puntos",
  ),
  const Choice(
    title: 'Visual Design', 
    ...
    mision: "Pregúntale a Pri sobre Inlearning, si no la encuentras pregúntale a Diego.",
    points: "3 puntos",
  ),
  const Choice(
    title: 'DEV', 
    ...
    mision: "Conoce a cualquier chico Dev y pregúntale que está viendo en este Sprint, si no lo encuentras pregúntale a Diego.",
    points: "4 puntos",
  ),
  const Choice(
    title: 'QA', 
    ...
    mision: "Encuentra la persona que ve QA dinos su nombre y cuántos bugs detectó en el sprint pasado, si no lo encuentras pregúntale a Diego.",
    points: "3 puntos",
  ),
  const Choice(
    title: 'AGILE', 
    icon: Icons.feedback, 
    description:"Seguimos las ceremonias del marco de trabajo ágil SCRUM en todos los proyectos",
    mision: "Pregúntale a Kati que es Tunking, si no la encuentras pregúntale a Diego.",
    points: "3 puntos",
  ),
  const Choice(
    title: 'BUSINESS', 
    icon: Icons.business, 
    description:"El enfoque económico y de negocio es muy importante para cada proyecto guiándonos de indicadores y KPIs, podemos medir el comportamiento e impacto que generan cada uno",
    mision: "Pregúntale a Jorge sobre CRM, si no lo encuentras pregúntale a Diego.",
    points: "3 puntos",
  ),
  const Choice(
    title: 'PRODUCT OWNER', 
    ...
    mision: "Busca a Mauro y pregúntale sobre PEPE, si no lo encuentras pregúntale a Diego.",
    points: "3 puntos",
  ),
  const Choice(
    title: 'ZEGEL', 
